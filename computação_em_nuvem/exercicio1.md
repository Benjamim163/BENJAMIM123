...
Explique que são modelos de serviço em computação em nuvem e qual é o objetivo dessa classificação.

🔹 Questão 2 – IaaS
Defina o modelo IaaS (Infraestrutura como Serviço) e cite duas responsabilidades do usuário nesse modelo.
...
Associe corretamente os modelos de serviço às específicas:

( ) Permite ao usuário apenas utilizar o software via navegador. ( ) Oferece infraestrutura virtualizada como servidores e redes. ( ) fornecer uma plataforma pronta para desenvolvimento de aplicações.
...
( ) No modelo SaaS, o usuário é responsável pelas atualizações do sistema. ( ) O modelo IaaS oferece maior flexibilidade que o SaaS. ( ) No modelo PaaS, o desenvolvedor não precisa se preocupar com o sistema operacional.
...
a) Qual modelo de serviço em nuvem é o mais adequado? b) Justifique sua resposta.

🔹 Questão 10 – Dissertação
